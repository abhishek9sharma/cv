...
%\usepackage{apacite} % to add publications from bib
%\usepackage{bibentry}
%\makeatletter\let\saved@bibitem\@bibitem\makeatother
...
%                  Committee Members (\textit{internal}):  Dr. David Lo (chair), Dr. Jing Jiang, Dr. Hady W. Lauw\\
%			  \hspace{3.6cm}(\textit{external}): Dr. Nachiappan Nagappan, Microsoft Research
...
\nobibliography{cv-abhishek-academic}
%\nocite{*}
%%\bibliography{cv-abhishek-academic}
...
% \begin{enumerate}
% 	\item [2018] \tab  \bibentry{sharma2018recexperts}
% \end{enumerate}
...
%
%
%%\item[2015] \tab Boeing, G. \enquote{Planarity and Street Network Representation in Urban Form Analysis.} \textit{Environment and Planning B: Urban Analytics and City Science}, in press.
%
%\item[2018] \tab\bibentry{sharma2015s}
%
%
\end{tablist}
...
\begin{tablist}
%
	\item [2017] \tab \bibentry{tian2017apibot}
	\item [2017] \tab \bibentry{xia2017personality}	
	\item [2017] \tab \bibentry{sharma2017cataloging}
	\item [2017] \tab \bibentry{sharma2017harnessing}
	\item [2016] \tab \bibentry{sulistya2016spiteful}
	\item [2016] \tab \bibentry{sahoo2016temporal}
	\item [2015] \tab \bibentry{sharma2015s}
	\item [2015] \tab \bibentry{sharma2015nirmal}
%	
...
\subsection*{Publications In Progress}

\begin{tablist}
	%
	\item [2017] \tab \bibentry{sulistya2018sieve}
